...
" and operators, highlighting, run and ipdb breakpoints)
...
"                    undo after you re-open the file
...
" don't put icons on the sign
" column (it hides the vcs status
" icons of signify)
let g:syntastic_enable_signs = 0

" custom icons (enable them if
" you use a patched font, and enable the previous " setting)
...
nnoremap <buffer> <F8> :exec '!python -m pdb' shellescape(@%, 1)<cr>
nnoremap <buffer> <F7> :exec '!python3' shellescape(@%, 1)<cr>
nnoremap <buffer> <F6> :exec '!python3 -m pdb' shellescape(@%, 1)<cr>
...
" open definitions on same window, and custom mappings for
...
"
"  if you don't want to manually control it you can open this setting
